    ...
    try {
      ...
      try {
        ...
        if (chat = global.DATABASE._data.chats[m.chat]) {
          ...
          if (!'antiLink' in chat) chat.antiLink = ''
      ...
      let isBotAdmin = bot.isAdmin || bot.isSuperAdmin || false // Are you Admin?
        ...
        if (typeof plugin.before == 'function') if (await plugin.before.call(this, m, {
          ...
          if (!isPrems && plugin.limit && global.DATABASE._data.users[m.sender].limit < plugin.limit * 1) {
            this.reply(m.chat, `❌ Ups...\nLimit Kamu Habis! Hubungi *#Owner* untuk menambah limit kamu`, m)
...
global.dfail = (type, m, conn) => {
  let msg = {
    ...
    botAdmin: '*[ Link Grup Detected ]*\nJadikan Bot Sebagai *Admin* Untuk bisa kick otomatis bagi siapapun yg mengirim Link Grup Whatsapp Di Grup ini!\nAbaikan Pesan ini jika tidak ingin menggunakan fitur auto kick!',
    unreg: 'Silahkan daftar untuk menggunakan fitur ini dengan cara mengetik:\n\n*#daftar nama.umur*\n\nContoh: *#daftar Adji.19*'
  }[type]
